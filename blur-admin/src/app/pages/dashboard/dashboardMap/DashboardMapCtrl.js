(function () {
    ...
    /** @ngInject */
    function DashboardMapCtrl($scope, baConfig, layoutPaths) {
        ...
        var map = AmCharts.makeChart('amChartMap', {
            ...
            dataProvider: {
                ...
                zoomLatitude: 52,
                areas: [
                    {title: 'Spain', id: 'ES', color: layoutColors.primary, customData: ''+$scope.devicesPerCountry[0], groupId: '1'},
                    {title: 'France', id: 'FR', color: layoutColors.primary, customData: ''+$scope.devicesPerCountry[1], groupId: '1'},
                    {title: 'Germany', id: 'DE', color: layoutColors.success, customData: ''+$scope.devicesPerCountry[2], groupId: '2'},
                    {title: 'Luxembourg', id: 'LU', color: layoutColors.success, customData: ''+$scope.devicesPerCountry[3], groupId: '2'},
                    {title: 'Portugal', id: 'PT', color: layoutColors.successLight, customData: ''+$scope.devicesPerCountry[4], groupId: '3'}
            ...
            areasSettings: {
                ...
                balloonText: '[[title]]: [[customData]] devices'
            },
