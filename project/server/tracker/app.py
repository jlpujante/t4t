...
TEMPLATE_FILES = os.path.abspath(os.path.join(os.path.dirname(__file__), os.pardir, os.pardir, 'templates'))
STATIC_FILES = os.path.abspath(os.path.join(os.path.dirname(__file__), os.pardir, os.pardir, 'public'))
# DISABLE_CACHE = False
